...
update msg model =
    case msg of
        GotText result ->
            case result of
                Ok fullText ->
                    ( Success <| { data = spielerListe [ fullText ], xAAFunction = .age, yAAFunction = .overall , xName = "Age", yName = "Overall", filterNation = "Argentina", onOff = False, filterClub = "FC Barcelona", onOff2 = False, selectedValue1 = 3, selectedValue2 = 1 }, Cmd.none )
...
scatterplot model =
    ...
    svg [ viewBox 0 0 w h, TypedSvg.Attributes.width <| TypedSvg.Types.Percent 80, TypedSvg.Attributes.height <| TypedSvg.Types.Percent 80 ]
        [ style [] [ TypedSvg.Core.text """
            .point circle { stroke: rgba(0, 0, 155,0.1); fill: rgba(0, 0, 155,0.1); }
            .point text { display: none; }
            .point:hover circle { stroke: rgba(0, 0, 0,1.0); fill: rgb(118, 214, 78); }
            .point:hover text { display: inline; text-shadow: 0px 0px 4px rgb(255,255,255),0px 0px 6px rgb(255,255,255); fill: rgb(0,0,0)}
